...
# Output: Returns the seconds taken in floating point format, this can be captured by another script and fed into ONMS.net
...
url="https://onms.net/update.php?update_id=%s&key=%s&value=%s" % (update_id, key, elapsed)
